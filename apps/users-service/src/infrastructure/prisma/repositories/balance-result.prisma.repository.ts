...
import {
  CreateBalanceResult,
  UpdateBalanceResult,
} from '@app/users-service/domain/entities/balance-result/balance-result.type';
import { CurrencyType } from '@app/users-service/domain/value-objects/currency-type';
import { BalanceResultPrismaMapper } from '@app/users-service/infrastructure/prisma/mapper/balance-result.prisma.mapper';
