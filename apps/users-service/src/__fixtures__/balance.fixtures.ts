...
import { UserBalanceProps } from '@app/users-service/domain/entities/user-balance/user-balance.type';
import { BalanceResult } from '@app/users-service/domain/entities/balance-result/balance-result';
import { BalanceResultProps } from '@app/users-service/domain/entities/balance-result/balance-result.type';
import { BalanceLedgerEntry } from '@app/users-service/domain/entities/balance-ledger-entry/balance-ledger-entry';
import { BalanceLedgerEntryProps } from '@app/users-service/domain/entities/balance-ledger-entry/balance-ledger-entry.type';
import { BalanceAmount } from '@app/users-service/domain/value-objects/balance-amount';
import { CurrencyType } from '@app/users-service/domain/value-objects/currency-type';
import { OperationType } from '@app/users-service/domain/value-objects/operation-type';
import { OperationStatus } from '@app/users-service/domain/value-objects/operation-status';
import { LedgerReason } from '@app/users-service/domain/value-objects/ledger-reason';
import BigNumber from 'bignumber.js';
import type { CreateUserBalanceRequestDto } from '@app/users-service/application/use-cases/create-user-balance/create-user-balance.dto';
import type { GetUserBalanceResponseDto } from '@app/users-service/application/use-cases/get-user-balance/get-user-balance.dto';
