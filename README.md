...
- **Архитектура микросервисов**: 8 независимых сервисов, взаимодействующих через NATS
...
- **`game-server`** — Игровая симуляция в реальном времени (WebSocket, GameLoop, физика, лаг-компенсация)
- **`analytics-service`** — Сбор событий, интеграция с ClickHouse
