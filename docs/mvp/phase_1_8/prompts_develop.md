# Промпт: РАЗРАБОТКА — TASK-2.4: Local Orchestrator
...
1. В `docs/mvp/phase_1_8/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 8 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/22_service_contracts.md, docs/architecture/27_connection_handling.md
