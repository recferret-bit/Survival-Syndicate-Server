# Промпт: РЕВЬЮ — TASK-2.4: Local Orchestrator
...
**Тесты:**
- [ ] Unit-тесты покрывают: SlotManager, GracePeriodService, ReconnectRequestHandler, HeartbeatService
- [ ] Integration-тесты: NATS reconnect_request request/reply
...
1. В `docs/mvp/phase_1_8/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 8 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_8/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_8/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 8 на `✅ DONE`.
