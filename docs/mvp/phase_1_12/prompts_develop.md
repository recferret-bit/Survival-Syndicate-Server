# Промпт: РАЗРАБОТКА — TASK-3.1: E2E: базовый флоу
...
1. В `docs/mvp/phase_1_12/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 12 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/mvp_plan.md (TASK-3.1)
