# Промпт: РЕВЬЮ — TASK-3.1: E2E: базовый флоу
...
- [ ] Integration-тесты: Полный E2E тест
...
1. В `docs/mvp/phase_1_12/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 12 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_12/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_12/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 12 на `✅ DONE`.
