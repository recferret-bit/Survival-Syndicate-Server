# Промпт: РЕВЬЮ — TASK-2.5: Gameplay Service
...
**Тесты:**
- [ ] Unit-тесты покрывают: SimulationManager, GameSimulation stub, HeartbeatService
- [ ] Integration-тесты: NATS start_simulation -> simulation created
...
1. В `docs/mvp/phase_1_9/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 9 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_9/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_9/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 9 на `✅ DONE`.
