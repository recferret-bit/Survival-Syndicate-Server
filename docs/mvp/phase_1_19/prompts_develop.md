# Промпт: РАЗРАБОТКА — TASK-4.5: collector-service (шаблон)
...
1. В `docs/mvp/phase_1_19/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 19 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/03_analytics_and_events.md
