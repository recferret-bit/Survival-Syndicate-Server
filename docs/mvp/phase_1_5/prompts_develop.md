# Промпт: РАЗРАБОТКА — TASK-2.1: Auth Service
...
1. В `docs/mvp/phase_1_5/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 5 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/17_auth_and_authorization.md, docs/architecture/18_error_handling.md
