# Промпт: РАЗРАБОТКА — TASK-3.3: E2E: защита слота
...
1. В `docs/mvp/phase_1_14/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 14 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/27_connection_handling.md, docs/mvp_plan.md (TASK-3.3)
