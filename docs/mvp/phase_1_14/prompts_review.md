# Промпт: РЕВЬЮ — TASK-3.3: E2E: защита слота
...
**Тесты:**
- [ ] Unit-тесты покрывают: Нет
- [ ] Integration-тесты: E2E slot protection scenarios
...
1. В `docs/mvp/phase_1_14/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 14 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_14/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_14/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 14 на `✅ DONE`.
