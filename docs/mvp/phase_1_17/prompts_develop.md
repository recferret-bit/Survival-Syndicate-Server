# Промпт: РАЗРАБОТКА — TASK-4.3: combat-progress-service (шаблон)
...
1. В `docs/mvp/phase_1_17/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 17 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/10_combat_progress_service.md
