# Промпт: РЕВЬЮ — TASK-4.3: combat-progress-service (шаблон)
...
**Тесты:**
- [ ] Unit-тесты покрывают: Нет (шаблон)
...
1. В `docs/mvp/phase_1_17/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 17 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_17/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_17/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 17 на `✅ DONE`.
