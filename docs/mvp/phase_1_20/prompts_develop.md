# Промпт: РАЗРАБОТКА — TASK-4.6: payment-service (шаблон)
...
1. В `docs/mvp/phase_1_20/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 20 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/06_payment_validation_service.md
