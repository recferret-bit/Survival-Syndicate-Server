# Промпт: РЕВЬЮ — TASK-3.2: E2E: реконнект
...
- [ ] Integration-тесты: E2E reconnect scenarios
...
1. В `docs/mvp/phase_1_13/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 13 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_13/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_13/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 13 на `✅ DONE`.
