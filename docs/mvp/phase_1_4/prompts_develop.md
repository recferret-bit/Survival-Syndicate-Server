# Промпт: РАЗРАБОТКА — TASK-1.4: Скаффолдинг MVP-сервисов
...
1. В `docs/mvp/phase_1_4/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 4 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/16_project_structure.md, docs/mvp_plan.md (секция TASK-1.4)
