# Промпт: РАЗРАБОТКА — TASK-4.4: scheduler-service (шаблон)
...
1. В `docs/mvp/phase_1_18/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 18 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/12_scheduler_service.md
