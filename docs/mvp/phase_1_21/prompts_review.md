# Промпт: РЕВЬЮ — TASK-4.7: history-service (шаблон)
...
1. В `docs/mvp/phase_1_21/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 21 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_21/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_21/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 21 на `✅ DONE`.
