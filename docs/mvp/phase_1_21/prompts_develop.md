# Промпт: РАЗРАБОТКА — TASK-4.7: history-service (шаблон)
...
1. В `docs/mvp/phase_1_21/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 21 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/29_match_history_system.md
