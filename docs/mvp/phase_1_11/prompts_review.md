# Промпт: РЕВЬЮ — TASK-2.7: WebSocket Service — reconnect
...
**Тесты:**
- [ ] Unit-тесты покрывают: ReconnectHandler, LobbyStateSyncService
- [ ] Integration-тесты: WS reconnect pipeline
...
1. В `docs/mvp/phase_1_11/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 11 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_11/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_11/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 11 на `✅ DONE`.
