# Промпт: РЕВЬЮ — TASK-2.2: Player Service
...
**Тесты:**
- [ ] Unit-тесты покрывают: CreateProfileHandler, GetPlayerHandler, PlayerEntity, PlayerPrismaMapper
- [ ] Integration-тесты: NATS user.registered -> profile creation, HTTP GET /api/players/me
...
1. В `docs/mvp/phase_1_6/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 6 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_6/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_6/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 6 на `✅ DONE`.
