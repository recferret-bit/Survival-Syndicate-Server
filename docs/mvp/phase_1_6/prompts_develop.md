# Промпт: РАЗРАБОТКА — TASK-2.2: Player Service
...
1. В `docs/mvp/phase_1_6/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 6 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/11_player_service.md, docs/architecture/22_service_contracts.md
