# Промпт: РЕВЬЮ — TASK-2.3: Matchmaking Service
...
**Тесты:**
- [ ] Unit-тесты покрывают: CreateLobbyHandler, JoinLobbyHandler, LeaveLobbyHandler, StartMatchHandler, LobbyEntity
- [ ] Integration-тесты: Lobby HTTP pipeline, NATS found_match publication
...
1. В `docs/mvp/phase_1_7/task.md` замени статус на `IN REVIEW`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 7 на `👁️ IN REVIEW`.
...
**Задача:** docs/mvp/phase_1_7/task.md

Co-Authored-By: Oz <oz-agent@warp.dev>"
```

### Шаг 6: После мержа
1. В `docs/mvp/phase_1_7/task.md` замени статус на `DONE`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 7 на `✅ DONE`.
