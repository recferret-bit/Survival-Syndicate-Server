# Промпт: РАЗРАБОТКА — TASK-4.2: building-service (шаблон)
...
1. В `docs/mvp/phase_1_16/task.md` замени статус на `IN PROGRESS`.
2. В `docs/mvp/mvp_phase_1.md` обнови статус задачи 16 на `🛠️ IN PROGRESS`.

### Шаг 2: Изучение паттернов
1. Прочитай документацию: docs/architecture/09_building_service.md
